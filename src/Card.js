...
function Card(props) {
  let images = {
    ...
    InstagramIcon: <InstagramIcon fontSize="large" id="imageIcon" />,
  ...
  let projectsDisc = {
    ...
    "Voice Assistant": (
      <p>
        ...
        <br />
        <br />
        This app can perform basic tasks like opening apps, playing music,
        searching on the internet, setting alarms, display calendar events and
        many more.
        <br />
        <br />
    ...
    "Instagram Clone": (
      <p>
        ...
        Developed an <strong>Instagram Clone</strong> app using{" "}
        <strong>React</strong>, <strong>Firebase</strong> and{" "}
        <strong>Material UI</strong>. This app allows users to{" "}
        <strong>create accounts</strong>, <strong>login</strong> and{" "}
        <strong>logout</strong>.
        <br />
        <br />
        Users can <strong>upload images</strong>, <strong>add captions</strong>{" "}
        and <strong>comments</strong>. This app also has a{" "}
        <strong>real time database</strong> that stores all the posts.
      </p>
    ),
    "Website Portfolio": (
      <p>
    ...
    OGSA: (
      <p>
        ...
        OGSA is an <strong>E-commerce</strong> website that allows users to buy
        tickets for an event.
        <br />
        <br />
        Established different <strong>role-based permissions</strong> to
        safeguard sensitive data and guarantee that users only have access to
        the data they require.
        <br />
        <br />
        It is developed using <strong>React</strong> and{" "}
        <strong>Material UI</strong> for the frontend and{" "}
        <strong>Node.js</strong> and <strong>Express</strong> for the backend.
        It uses <strong>Firebase</strong> as the database and{" "}
        <strong>Firebase Storage</strong> for image storage. It also uses{" "}
    ...
    Puzzle: (
      <p>
        ...
        This program solves X number of randomly generated{" "}
        <strong>8 and 15 Puzzle</strong> using <strong>A* Search</strong>{" "}
        algorithm
        <br />
        <br />
